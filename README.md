...
*/	
	...
	switch (nom) {
	    ...
	    popAnimal[1]=nb;//On initialise la case des animaux âgés de 1 an à un nombre que nous avons choisi
	...
	public boolean famine (){//Vérifie si le nombre d'individu d'une espèce à diminuer
